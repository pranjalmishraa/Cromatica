...
session_start();
			 ...
			 <div><b>Cromatica</b></div>
                ...
                ;
				$html1='Please action on the online enquiry received from cromatica website with the below details :<br>
				Home type :  '.$prop.'
				Name : '.$name.'
				Mobile_no: '.$number.' 
				Email Id: '.$email.'
...
echo smtp_mailer('lead_notifications@cromatica.in','subject',$html1);
function smtp_mailer($to,$subject, $msg){
	...
	$mail->IsHTML(true);
	$mail->CharSet = 'UTF-8';
	$mail->Username = "lead_notifications@cromatica.in";
	$mail->Password = "Cromatica2021";
	$mail->SetFrom("lead_notifications@cromatica.in");
	...
	if(!$mail->Send()){
		...
		In case you are unable to get the help you need in the time that you expect, please feel free to contact us on +91 7618778060 or drop a mail to info@cromatica.in
